  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved notice as @notice" do
        ...
        post :create, {:notice => { "id" => "invalid value" }}, valid_session
        assigns(:notice).should be_a_new(Notice)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested notice" do
        ...
        Notice.any_instance.should_receive(:update_attributes).with({ "id" => "MyString" })
        put :update, {:id => notice.to_param, :notice => { "id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the notice as @notice" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Notice.any_instance.stub(:save).and_return(false)
        put :update, {:id => notice.to_param, :notice => { "id" => "invalid value" }}, valid_session
        assigns(:notice).should eq(notice)
      end

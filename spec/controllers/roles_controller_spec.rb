  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved role as @role" do
        ...
        post :create, {:role => { "id" => "invalid value" }}, valid_session
        assigns(:role).should be_a_new(Role)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested role" do
        ...
        Role.any_instance.should_receive(:update_attributes).with({ "id" => "MyString" })
        put :update, {:id => role.to_param, :role => { "id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the role as @role" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Role.any_instance.stub(:save).and_return(false)
        put :update, {:id => role.to_param, :role => { "id" => "invalid value" }}, valid_session
        assigns(:role).should eq(role)
      end
